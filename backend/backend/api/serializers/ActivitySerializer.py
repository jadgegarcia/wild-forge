...
class ActivitySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Activity
        fields = ('id', 'classroom_id', 'team_id', 'activityCriteria_id', 'title', 'description', 'instruction', 'submission_status', 'date_created', 'due_date', 'evaluation', 'total_score','return_status', 'spring_project','submission_attempts')
