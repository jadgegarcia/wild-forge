# Generated by Django 4.2.4 on 2025-03-13 17:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[(0, 'Admin'), (1, 'Moderator'), (2, 'Basic'), (3, 'Guest')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.PositiveSmallIntegerField(blank=True, choices=[(0, 'Teacher'), (1, 'Student'), (2, 'Guest')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('guest_weight_score', models.DecimalField(decimal_places=2, default=0, max_digits=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('date_created', models.DateTimeField(auto_now=True)),
                ('classroom', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='wildforge_api.classroom')),
            ],
        ),
        migrations.CreateModel(
            name='Remark',
